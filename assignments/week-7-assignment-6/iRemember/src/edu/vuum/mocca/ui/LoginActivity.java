...
public class LoginActivity extends StoryActivityBase{
	...
	// The correct value to assign is SECURITY_PRIVATE, to avoid these potential problems is recommended to use
	// an enum that limit the values to set instead of an Integer
