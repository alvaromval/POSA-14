...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	Intent service = DownloadIntentService.makeIntent(view.getContext(), handler, getUrlString());
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	Intent servicePool = ThreadPoolDownloadService.makeIntent(view.getContext(), handler, getUrlString());
        	startService(servicePool);
